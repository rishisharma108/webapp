...
if ($result->num_rows > 0) {
	 echo "<center><h1><font color=#ff66cc>Edit Cat's List</font></h1></center><table border='2' bordercolor='ff6699' align='center' width='80%' height='50%' bgcolor='ffccff'><tr><center>
	 ...
	 <th><font color='3399ff'>Edit</font></th>
	 </center></tr>";
	while($row = $result->fetch_assoc()) {
		...
		<td><center><a href='edit.php?edit_id=";
		echo $id;
		echo "'>Edit</a></td></center>
		</tr>";
     }
	 echo "</table>";
} else {
